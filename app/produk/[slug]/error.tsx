...
export default function ProductError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <main data-ui-system="canonical" className="debroder-storefront grid min-h-[60vh] place-items-center bg-brand-offWhite px-5 text-center">
      <div className="max-w-md bg-brand-offWhite p-8">
