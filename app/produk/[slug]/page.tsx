        ...
        <div className="section-shell">
          ...
          <div className="mt-6 grid gap-8 lg:grid-cols-2 lg:gap-12">
            ...
            <div className="self-start lg:sticky lg:top-24">
              ...
              <div className="mt-5 flex flex-wrap items-baseline gap-3"><p className="text-2xl font-semibold">{priceLabel}</p>{product.compare_price ? <p className="text-base text-brand-charcoal/45 line-through">{formatRupiah(product.compare_price)}</p> : null}</div>
