...
export const fallbackPageHeroes: PageHeroContent[] = [
  ...
  {
    page_key: "aksesori-lainnya",
    label: "TAS & AKSESORI",
    title: "Aksesori Lainnya Custom",
    subtitle: "Patch, emblem, lanyard, goodie bag, merchandise, dan aksesori promosi.",
    image_url: pageHeroImageFallbacks["aksesori-lainnya"],
    mobile_image_url: pageHeroMobileImageFallbacks["aksesori-lainnya"],
    object_position: "center center",
    mobile_object_position: "center center",
    status_aktif: true
  },
