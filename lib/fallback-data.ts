...
export const pageHeroImageFallbacks: Record<string, string> = {
  ...
  "tas-aksesori": "/images/debroder/page-heroes/hero-headwear.jpg",
...
export const pageHeroMobileImageFallbacks: Record<string, string> = {
  ...
  "tas-aksesori": "/images/debroder/page-heroes/hero-headwear-mobile.jpg",
...
export const fallbackPageHeroes: PageHeroContent[] = [
  ...
  },
  {
    ...
    subtitle: "Polo shirt untuk seragam kantor, komunitas, event, dan bordir logo.",
    image_url: pageHeroImageFallbacks["polo-shirt"],
    mobile_image_url: pageHeroMobileImageFallbacks["polo-shirt"],
    object_position: "center center",
    mobile_object_position: "center center",
    status_aktif: true
  },
  ...
  {
    page_key: "tas-aksesori",
    label: "TAS & AKSESORI",
    title: "Tas & Aksesori Custom",
    subtitle: "Tote bag, goodie bag, patch, emblem, lanyard, dan aksesori promosi.",
    image_url: pageHeroImageFallbacks["tas-aksesori"],
    mobile_image_url: pageHeroMobileImageFallbacks["tas-aksesori"],
    object_position: "center center",
    mobile_object_position: "center center",
    status_aktif: true
  },
