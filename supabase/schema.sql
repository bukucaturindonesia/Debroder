...
create table if not exists public.page_heroes (
  ...
  image_url text not null default '/debroder/fallback/fallback-page-hero-desktop-12x5.svg',
  image_alt text,
  mobile_image_url text,
  detail_image_url text,
  detail_image_alt text,
  detail_object_position text not null default 'center center',
  detail_focal_x numeric,
  detail_focal_y numeric,
  detail_focal_zoom numeric not null default 1,
  detail_target_ratio text not null default '4:3',
  object_position text not null default 'center center',
  mobile_object_position text not null default 'center center',
  object_fit text not null default 'cover' check (object_fit in ('cover', 'contain')),
  focal_x numeric,
...
create table if not exists public.trust_about_content (
  ...
  image_url text,
  mobile_image_url text,
  about_page_image_url text,
  about_page_mobile_image_url text,
  about_page_object_position text not null default 'center center',
  about_page_mobile_object_position text not null default 'center center',
  about_page_focal_x numeric,
  about_page_focal_y numeric,
  about_page_focal_zoom numeric not null default 1,
  about_page_target_ratio text not null default '4:5',
  about_page_mobile_focal_x numeric,
  about_page_mobile_focal_y numeric,
  about_page_mobile_focal_zoom numeric not null default 1,
  about_page_mobile_target_ratio text not null default '4:5',
  status_aktif boolean not null default true,
  created_at timestamptz not null default now(),
  updated_at timestamptz not null default now()
);
