  ...
  return (
    <main className="flex min-h-[60vh] items-center justify-center bg-brand-offWhite px-5 py-16">
      <div className="max-w-lg text-center">
        ...
        <button type="button" onClick={reset} className="mt-6 inline-flex min-h-11 items-center justify-center rounded-full bg-black px-6 text-sm font-semibold text-white hover:bg-black/75 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-black">Coba Lagi</button>
      </div>
    </main>
  );
}
