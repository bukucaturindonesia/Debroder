...
Menetapkan satu vocabulary spacing canonical dan mencegah random pixel values.

## Scope

Gap, padding, margin, section rhythm, component internals, dan alignment offsets.
...
kecuali ada alasan optikal.

## Detailed Specification

### Domain intent

- Gunakan hanya token canonical ketika nilai tertentu tidak ditetapkan langsung oleh component.
- Random value hanya dibenarkan oleh alasan optikal yang eksplisit.
- Range canonical tidak boleh dipersempit menjadi nilai tunggal tanpa kebutuhan component.
...
- [Master Token Contract](05-master-token-contract.md)
