...
Mengontrol shape, border, dan elevation agar UI premium namun tidak penuh rounded/shadow.

## Scope

Controls, cards, elevated surfaces, drawers, modals, dan micro elements.
...
4px   — micro
8px   — compact
12px  — control / product
16px  — default card
20px  — large surface
999px — pill
```

Dilarang menggunakan rounded-xl/2xl/3xl secara random.
...
Gunakan border untuk struktur.

Tidak semua kartu wajib memiliki border.
...
Jangan menggunakan shadow besar pada product card.

## Detailed Specification

### Domain intent

- Radius harus memilih token berdasarkan semantic role.
- Border default 1px subtle neutral dipakai untuk struktur, bukan kewajiban pada semua card.
- Product card menggunakan S0.
- Elevation meningkat hanya ketika hierarchy/overlay membutuhkannya.
