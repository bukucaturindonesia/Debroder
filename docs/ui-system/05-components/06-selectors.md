...
Mengatur Size Selector dan Color Swatch agar selected state jelas, accessible, dan selaras dengan PDP commerce priority.

## Scope

PDP dan component lain yang memakai pilihan ukuran/warna yang sama.
...
Selected state wajib terlihat jelas.
...
- Size selector 3×3 XS–5XL dengan height 48px/minimum 44px.
- Color swatch visual 32–36px dengan hit area 44px.
- Color selection tidak boleh hanya dikomunikasikan melalui warna.
