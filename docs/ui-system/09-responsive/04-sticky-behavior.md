...
Mengatur conditional sticky UI agar membantu task tanpa menutup content atau melanggar stacking.

## Scope

Navbar, PDP detail panel, mobile CTA, cart summary, admin sidebar.
...
Tidak boleh menutup konten.

## Detailed Specification

### Domain intent

- Mobile sticky CTA jika digunakan: 64–72px + safe area.
- Sticky UI tidak boleh menutup content.
- PDP detail sticky top recommended = navbar height + 24px.
- Cart summary sticky desktop; admin sidebar fixed.
