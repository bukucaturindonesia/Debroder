...
Menetapkan Geist Sans, typography scale, hierarchy, dan penggunaan role tanpa random font size.

## Scope

Editorial, commerce, customer, admin, metadata, caption, dan supporting content.

## Canonical Rules

### Master §13 — FONT FAMILY
...
Jangan menggunakan banyak font family.
...
Teks utama tidak boleh lebih kecil dari 12px.

### Master §15 — TYPOGRAPHY PHILOSOPHY

Premium tidak berarti semua teks besar.

Hierarchy dibentuk oleh:
...
Gunakan ukuran besar hanya bila memang memiliki prioritas tinggi.
...
- Premium tidak berarti semua teks besar.
- Hierarchy menggunakan scale bersama weight, contrast, whitespace, position, dan tracking.
- Teks utama tidak boleh di bawah 12px.
- Admin memiliki scale lebih compact melalui domain-specific contract.
...
- [Price Typography](04-price-typography.md)
