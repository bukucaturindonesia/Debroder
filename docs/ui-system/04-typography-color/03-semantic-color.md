...
Memisahkan fungsi brand green dari semantic red/yellow/blue/status green.

## Scope

Caution, unfinished, error, warning, information, success/positive state, badges, validation, dan attention.
...
Merah bukan warna dekoratif.

Jika ada catatan kaki yang menunjukkan pekerjaan belum selesai, wajib berwarna merah.
...
Untuk warning yang tidak bersifat error fatal.
...
Boleh dibedakan dari Hijau DEBRODER bila diperlukan untuk menghindari semantic confusion.

## Detailed Specification

### Domain intent

- Merah bukan dekorasi.
- Unfinished/caution/error/failed/attention memakai merah sesuai Master.
- Kuning untuk warning non-fatal; biru untuk informasi sistem.
- Status green boleh dibedakan dari brand green untuk menghindari confusion.
