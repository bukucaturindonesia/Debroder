...
Menjabarkan behavior yang sudah pasti dan memisahkannya dari media decisions yang masih open.

## Scope

Object-fit product images, hero backgrounds, editorial ratios, loading/fallback/zoom/crop concerns.
...
- **Master §10 — BACKGROUND SYSTEM** — dipakai sebagai contextual source; canonical ownership berada di domain primary-nya.
- **Master §26 — PRODUCT IMAGE RULE** — dipakai sebagai contextual source; canonical ownership berada di domain primary-nya.
- **Master §38 — HERO SYSTEM** — dipakai sebagai contextual source; canonical ownership berada di domain primary-nya.
- **Master §42 — PDP GALLERY** — dipakai sebagai contextual source; canonical ownership berada di domain primary-nya.
- **Master §80 — MASTER PHOTOGRAPHY & MEDIA** — dipakai sebagai contextual source; canonical ownership berada di domain primary-nya.

## Detailed Specification

### Domain intent

- Product image uses width/height 100% and object-fit cover.
- Tidak boleh stretch, random crop, atau mencampur portrait/square dalam section sama.
- Hero readability veil conditional.
- Detail thumbnail/zoom/crop/fallback/loading/layout-shift behavior belum final.
