...
Menjabarkan page/header/content organization account tanpa menambahkan data model atau business rule.

## Scope

Profil, alamat, favorit, settings-like views, dan account sections.
...
- Sidebar/content mengikuti Customer Shell canonical.
- Primary account task harus jelas per page.
- Cards hanya digunakan ketika role-nya jelas; jangan membuat setiap datum menjadi card.
- Empty/error/loading memakai system states global.
