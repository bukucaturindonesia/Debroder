...
Menjabarkan responsive transformation area pelanggan berdasarkan customer shell dan master responsive principles.

## Scope

Sidebar/menu, content stacking, cards, actions, and customer navigation.
...
- Desktop sidebar menjadi menu/drawer di mobile.
- Detail responsive matrix yang belum ditentukan tetap open decision.
- Touch target, focus, dan content priority tetap berlaku di semua viewport.
