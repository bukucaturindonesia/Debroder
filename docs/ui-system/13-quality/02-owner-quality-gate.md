...
Mempertahankan 12 pertanyaan Owner Quality Rule sebagai final visual/UX gate.

## Scope

Semua UI sebelum dinyatakan selesai.

## Canonical Rules

### Master §84 — OWNER QUALITY RULE

Sebelum UI dianggap selesai, tanyakan:

1. Apakah fungsi utama halaman terlihat dalam ≤5 detik?
2. Apakah elemen terpenting memiliki visual weight tertinggi?
3. Apakah card sejenis memiliki ukuran konsisten?
4. Apakah spacing mengikuti token?
5. Apakah typography mengikuti hierarchy?
6. Apakah layout mengikuti master grid?
7. Apakah surface memiliki alasan?
8. Apakah mobile memiliki prioritas commerce yang benar?
9. Apakah dekorasi tidak mengalahkan produk?
10. Apakah halaman terasa berasal dari sistem yang sama?
11. Apakah seluruh UI menggunakan Bahasa Indonesia?
12. Apakah unfinished item ditandai merah?
...
- Semua 12 pertanyaan harus dijawab secara terpisah.
- Jika satu saja tidak jelas, UI belum selesai.
- Gate memeriksa focus, hierarchy, consistency, grid, surface, mobile priority, language, dan unfinished status.
