...
Mengatur Default, Dense, dan High Priority admin card tanpa mengubah seluruh data menjadi tiles.

## Scope

Admin summaries, context blocks, high-priority information, forms/groups.
...
Jangan membuat setiap angka menjadi satu kartu.

## Detailed Specification

### Domain intent

- Default 20px/16px radius; Dense 16px/12px; High Priority 24px/16–20px.
- Jangan membuat setiap angka menjadi satu kartu.
- Card hierarchy mengikuti P1–P5 dan density.
