...
Mendefinisikan baseline shell/section/container/grid nesting agar setiap page tidak membuat spacing architecture baru.

## Scope

Public page baseline; dapat diadaptasi customer/admin tanpa mengubah semantic nesting.

## Canonical Rules

### Master §78 — STANDARD PAGE TEMPLATE
...
Jangan membuat struktur spacing baru per halaman.

## Detailed Specification

### Domain intent

- AppShell → navigation → main → section → container → grid adalah baseline.
- Template mengatur struktur, bukan memaksa semua halaman memiliki visual yang sama.
- Page-specific layout boleh berbeda selama tetap menggunakan canonical alignment/tokens.
