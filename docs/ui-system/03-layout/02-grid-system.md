...
Mendefinisikan canonical 12/8/4-column grid dan card placement contract.

## Scope

Page layout, product grids, PDP, cart, customer, admin sections.
...
Semua kartu harus ditempatkan melalui:

Container → Grid → Column Span → Card

Dilarang memakai pixel positioning manual untuk layout utama.

## Detailed Specification

### Domain intent

- Primary layout mengikuti Container → Grid → Column Span → Card.
- Manual pixel positioning dilarang untuk layout utama.
- Gap mengikuti canonical per device.
- Nested layout harus tetap align ke parent grid/content edge.
