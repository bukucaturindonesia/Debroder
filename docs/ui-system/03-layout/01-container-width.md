...
Mengatur max-width, horizontal padding, full-bleed, commerce width, dan reading width.

## Scope

Public pages, commerce, customer, admin content canvas, hero, dan long-form pages.
...
Layar besar tetap menggunakan content max-width 1280px.

Hero dan background boleh full width.

### Master §6 — CONTENT WIDTH LEVELS
...
- Commerce content tetap max-width 1280px pada layar besar.
- Hero/background dapat full width tetapi content alignment tetap memiliki logic.
- Reading width hanya untuk long-form content.
- Horizontal padding berubah sesuai device class sebagaimana Master.
