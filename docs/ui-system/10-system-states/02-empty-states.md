...
Menetapkan required empty states dan anatomy action-oriented yang konsisten.

## Scope

Cart, search, orders, favorites, addresses, admin tables.

## Canonical Rules

### Master §64 — EMPTY STATE

Wajib tersedia untuk:
...
- Anatomy: optional icon/illustration, title, description, primary action, optional secondary action.
- Empty state tidak boleh terlihat seperti error bila tidak ada failure.
- Primary action harus relevan dengan task recovery/discovery.
...
- [Error, Warning & Success](03-error-warning-success.md)
