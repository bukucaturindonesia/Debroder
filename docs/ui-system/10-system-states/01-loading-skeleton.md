...
Mengatur loading feedback yang mempertahankan layout shape dan menghindari fullscreen spinner untuk data ringan.

## Scope

Navigation, catalog, PDP, cart, checkout, account, admin.

## Canonical Rules

### Master §63 — LOADING

Gunakan skeleton yang mengikuti bentuk konten sebenarnya.
...
Hindari spinner fullscreen untuk data ringan.

## Detailed Specification

### Domain intent

- Product skeleton: 4:5 image + text bar + text bar + price bar.
- Skeleton mengikuti content geometry aktual.
- Loading state tidak boleh menggeser layout atau mengubah control size.
- Detail media loading behavior final tetap mengikuti open decision registry bila belum ditentukan.
